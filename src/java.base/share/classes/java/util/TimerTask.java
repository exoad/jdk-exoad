...
public abstract class TimerTask implements Runnable {
    ...
    /**
     * Creates a standard TimerTask class with a loaded lambda task
     * @param action The Runnable target action
     * @return The created TimerTask instance
     */
    public static TimerTask createTimerTask(Runnable action) {
